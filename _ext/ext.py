...
class Tutorials(Directive):
    ...
    def run(self):
        ...
        intro = f"""
<p>
<b>FEMlium</b> is accompanied by a few tutorials, composed of two consecutive steps (mesh generation, and visualization of the results).
</p>
"""
...
"""
    ...
    def _library_image(library):
        ...
        elif library in ("meshio", "meshio & numpy"):
            logo = "_static/images/meshio-logo.png"
        else:
...
<script type="application/ld+json">
{
  ...
  "description": "FEMlium is a library that enables visualizing finite element simulations on geographic maps using folium. FEMlium is currently developed at Catholic University of the Sacred Heart by Dr. Francesco Ballarin.",
...
<meta property="og:description" content="FEMlium is a library that enables visualizing finite element simulations on geographic maps using folium. FEMlium is currently developed at Catholic University of the Sacred Heart by Dr. Francesco Ballarin." />
<meta property="og:type" content="website" />
<meta property="og:site_name" content="FEMlium" />
<meta property="og:url" content="https://femlium.github.io/" />
<meta property="og:image" content="https://femlium.github.io/_images/FEMlium-logo.png" />
"""
